...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FlagQuizz.Acitivty.HomeActivity, FlagQuizz", HomeActivity.class, __md_methods);
	}
	...
	public HomeActivity ()
	{
		...
		if (getClass () == HomeActivity.class)
			mono.android.TypeManager.Activate ("FlagQuizz.Acitivty.HomeActivity, FlagQuizz", "", this, new java.lang.Object[] {  });
	}
