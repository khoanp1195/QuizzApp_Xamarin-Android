...
namespace FlagQuizz
{
    ...
    public class MainActivity2 : AppCompatActivity
    {
        ...
        MoreFragment searchFragment = new MoreFragment();
        SettingFragment earningsFragment = new SettingFragment(); 
        ProfileFragment weatherFragment = new ProfileFragment();
        ...
        private void SetupViewPager()
        {
            ...
            adapter.AddFragment(weatherFragment, "Account");
            adapter.AddFragment(searchFragment, "Rating");
